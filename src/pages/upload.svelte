...
<section class="py-8 px-4 text-center">
  ...
  <form class="content flex flex-col max-w-lg mx-auto">
    ...
    <Input id="description" type="text" placeholder="My recent trip to Norway!" className="field" bind:value={description} />
    </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {#if contentsShow}
              {#each contents as content, index}
                ...
                <h3 class="text-1xl mt-3 leading-normal font-medium text-gray-900 dark:text-gray-500 truncate">Description: {content.description}</h3>
