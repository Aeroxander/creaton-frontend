      ...
      <div class="container mx-auto px-4">
        <div class="flex flex-wrap">
          <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
            <div
              class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-l-full"
            >
...
▶️
                ...
                <p class="mt-2 mb-4 text-gray-600">
                  Get exclusive content from creators through a streaming stablecoin subscription
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="w-full md:w-4/12 px-4 text-center">
            <div
              class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-full"
            >
              <div class="px-4 py-5 flex-auto">
                <div
                ...
                <p class="mt-2 mb-4 text-gray-600">
                  Earn money by creating content for subscribers and
                  investors betting on your creator token
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="pt-6 w-full md:w-4/12 px-4 text-center">
            <div
              class="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-r-full"
            >
              <div class="px-4 py-5 flex-auto">
                <div
...
📈
                ...
                <p class="mt-2 mb-4 text-gray-600">
                  Kickstart creator careers by investing in creator token,
                  receive a % of the profit with the % of tokens you own.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="container mx-auto px-4 w-full md:w-10/12">
        <div class="items-center flex flex-wrap">
          <div class="w-full md:w-4/12 ml-auto mr-auto px-4">
                        ...
                        <img
                alt="..."
                src="https://i.imgur.com/IM7pQmM.jpg"
